    ...
    *,
    ...
    try:
        ...
        with f:
            ...
            f.flush()
            os.fsync(f.fileno())
            # Some filesystems clear setuid/setgid on write. Restore the
            # complete source mode only after the payload is durable, then
            # fsync once more before publishing the replacement inode.
